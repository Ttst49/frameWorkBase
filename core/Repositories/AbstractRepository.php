...
abstract class AbstractRepository
{
    ...
    /**
     * Defining new abstract class managing all the repository's first uses
     * Make a constructor and shared methods for all the repositories using this repository as a parent
     */
